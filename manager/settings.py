...
SECRET_KEY = '-e%-zckhao-s=lz^0w0jgdp$3w@5omc@b3@wzze((ci&s_k7i1'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'manager/templates')
...
STATICFILES_DIRS = [
    ...
    ("documentation", os.path.join(STATIC_ROOT, 'documentation')),
    ("pages", os.path.join(STATIC_ROOT, 'pages')),
